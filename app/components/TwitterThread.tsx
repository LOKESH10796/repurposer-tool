    ...
    <div className="glass-card rounded-2xl p-8">
      <div className="flex items-center gap-3 mb-6">
        <div className="w-10 h-10 bg-blue-600/20 rounded-xl flex items-center justify-center">
          <span className="text-blue-400 text-2xl">≡¥òÅ</span>
        </div>
        <div>
          <div className="text-white text-lg font-semibold">Twitter Thread</div>
          <div className="text-slate-400 text-sm">Ready to post ΓÇö {tweets.length} tweets</div>
        </div>
      </div>
        ...
        {tweets.map((tweet, i) => (
          <div key={i} className="glass-card rounded-xl p-5 border border-white/5">
            <div className="flex items-center gap-2 mb-3">
              <span className="text-blue-400 text-sm font-bold">≡¥òÅ</span>
